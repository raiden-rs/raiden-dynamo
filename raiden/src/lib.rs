...
/// by `#[derive(RaidenIndex)]` for index projection models.
...
///
/// This trait is generated by `#[derive(RaidenIndex)]` and is used by typed GSI
/// builders to switch both the projection expression and the output type.
