...
mod tests {
    ...
    #[tokio::test]
    async fn test_batch_get_item_partial_missing() {
        let client = crate::all::create_client_from_struct!(BatchTest0);
        let res: batch_get::BatchGetOutput<BatchTest0> = client
    ...
    #[tokio::test]
    async fn test_batch_get_item_sort_key() {
    ...
    #[tokio::test]
    async fn test_batch_get_item_for_projection_expression() {
    ...
    #[tokio::test]
    async fn test_batch_get_item_missing_all() {
        let client = crate::all::create_client_from_struct!(BatchTest1);
    ...
    #[tokio::test]
    async fn test_batch_get_item_with_16mb_limitation() {
