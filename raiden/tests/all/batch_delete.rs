...
mod partition_key_tests {
    ...
    #[tokio::test]
    async fn test_batch_delete_item_for_stored_and_unstored_keys() {
        let client = crate::all::create_client_from_struct!(BatchDeleteTest0);
    ...
    #[tokio::test]
    async fn test_batch_delete_item_for_unstored_keys() {
        let client = crate::all::create_client_from_struct!(BatchDeleteTest0);
        let res = client
...
mod partition_key_and_sort_key_tests {
    ...
    #[tokio::test]
    async fn test_batch_delete_item_with_sort_key() {
    ...
    #[tokio::test]
    async fn test_batch_delete_item_with_sort_key_for_stored_and_unstored_keys() {
        let client = crate::all::create_client_from_struct!(BatchDeleteTest1);
        let res = client
    ...
    #[tokio::test]
    async fn test_batch_delete_item_with_sort_key_for_unstored_keys() {
        let client = crate::all::create_client_from_struct!(BatchDeleteTest1);
        let res = client
            .batch_delete(vec![
    ...
    #[tokio::test]
    async fn test_batch_delete_with_sort_key_over_25_items() {
        let client = crate::all::create_client_from_struct!(BatchDeleteTest1);
        let res = client
            .batch_delete(
                (4..=100)
